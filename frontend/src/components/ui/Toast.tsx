...
const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={`
        fixed z-50 min-w-80 max-w-md w-auto mx-auto p-4 border rounded-lg shadow-lg backdrop-blur-sm
    ...
    >      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1 min-w-0 pr-2">
          ...
          {message && (
            <p className="text-sm opacity-85 mt-1 leading-relaxed break-words">
              {message}
            </p>
          )}
        </div>
