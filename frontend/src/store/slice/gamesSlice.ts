...
import type { Game, GameReview } from '../../types/game';
...
export const { setGames, updateGame, updateGameRating, updateGameReview, addGame, deleteGame, updateGameStatus, updateGamePlaytime, updateGameNotes, updateGameCompletionDate, updateGamePlatinumDate, updateGamePlatform, updateGamePrice, updateGamePurchaseDate, updateGameMetacritic } = gamesSlice.actions;
