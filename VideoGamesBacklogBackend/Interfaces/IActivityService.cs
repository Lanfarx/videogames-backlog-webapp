...
namespace VideoGamesBacklogBackend.Interfaces
{
    ...
    {
        Task<PaginatedActivitiesDto> GetActivitiesAsync(int userId, ActivityQueryParameters queryParams);
        ...
        Task<PaginatedActivitiesDto> GetPublicActivitiesAsync(string userIdOrUsername, int currentUserId, ActivityQueryParameters queryParams);
